...
if (nav) nav.querySelectorAll("a").forEach((link) => {
  link.addEventListener("click", () => {
    if (toggle) { toggle.setAttribute("aria-expanded", "false"); toggle.querySelector(".sr-only").textContent = "Open navigation"; }
...
if (!reduceMotion && "IntersectionObserver" in window) document.documentElement.classList.add("js-motion");
